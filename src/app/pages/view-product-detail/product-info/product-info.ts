...
@Component({
  ...
  imports: [TitleCasePipe, StockStatus, QtySelector, MatIcon, 
            ToggleWishlistButton, MatButton, MatIconButton, StarRating],
  template: `
    ...
    <app-stock-status class="mb-4" [inStock]="product().inStock"/>
      ...
      <p class="text-gray-600 border-gray-200 pb-4">{{product().description}}</p>
