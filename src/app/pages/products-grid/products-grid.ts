...
@Component({
  ...
  imports: [
    ...
    ToggleWishlistButton, MatProgressSpinnerModule
  ],
  template: ` 
    ...
    <mat-sidenav-container>
      ...
      <mat-sidenav-content class="bg-grey-100 p-6 h-full">
          ...
          @for (product of store.filteredProducts(); track product.id) {
            ...
            <div class="flex flex-col items-center justify-center p-12 text-center bg-white rounded-lg shadow-sm">
            <p class="text-lg font-medium text-gray-700">No products found</p>
            <p class="text-sm text-gray-500 mt-1">Try searching for something else or picking a different category.</p>
          </div>
          }
